...
// připojení dat textu
	...
	{
		ASSERT(data != NULL, "Chyba připojení dat textové proměnné");
...
// odpojení (a zrušení) dat textu
	...
	{
		ASSERT(data != NULL, "Chyba odpojení dat textové proměnné");
		ASSERT(data->Refer > 0, "Chyba odpojení dat textové proměnné");
