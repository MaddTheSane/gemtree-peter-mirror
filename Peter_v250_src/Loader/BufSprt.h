...
// promìnné
	...
	bool			m_DispReq;				// (1) pøíznak požadavku pøekreslení
	...
	int				m_KrokCit;				// (4) èítaè fází pro celý pohyb
	...
	int				m_FazeNext;				// (4) pøíští fáze (urèená uživatelem), mimo rozsah=implicitní
...
// poskytnutí/nastavení pøíznaku požadavku pøekreslení
...
// poskytnutí/nastavení/dekrementace èítaèe fází pro celý pohyb
