...
// (pro kratší texty stejně nebude soubor menší)
...
#pragma comment(linker, "/MERGE:.data=.text")	// připojení sekcí
#pragma comment(linker, "/MERGE:.rdata=.text")	// připojení sekcí
